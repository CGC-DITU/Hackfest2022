const moviesList = [
  { movieName: "Brahmastra", price: 210 },
  { movieName: "Dragon Ball Super:Super Hero", price: 150 },
  { movieName: "One-piece:Red", price: 190 },
  { movieName: "Sonic", price: 160 }
];
...
moviesList.forEach((movie) => {
  ...
  optionEl.innerHTML = `${movie.movieName} &#x20B9 ${movie.price}`;
  selectMovieEl.appendChild(optionEl);
});

let moviePrice = 210;
let currentMovieName = `Brahmastra`;
